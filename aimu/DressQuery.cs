...
namespace aimu
{
    public partial class DressQuery : Form
    {
        ...
        public DressQuery(string wd_id)
        {
            InitializeComponent();
            initial();
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox1.Image);
            sbp.ShowDialog();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox2.Image);
            sbp.ShowDialog();
        }
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox3.Image);
            sbp.ShowDialog();
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox4.Image);
            sbp.ShowDialog();
        }
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox5.Image);
            sbp.ShowDialog();
        }
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox6.Image);
            sbp.ShowDialog();
        }
        ...
        private void pictureBox7_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox7.Image);
            sbp.ShowDialog();
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox8.Image);
            sbp.ShowDialog();
        }
        ...
        private void pictureBox9_Click(object sender, EventArgs e)
        {
            ...
            Form sbp = new DressImageShow(pictureBox9.Image);
            sbp.ShowDialog();
        }
