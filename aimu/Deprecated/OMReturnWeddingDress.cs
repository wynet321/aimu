...
namespace aimu
{
    public partial class OMReturnWeddingDress : Form
    {


        Boolean disableDoubleClient = false;
        public OMReturnWeddingDress()
        {
            InitializeComponent();
        }


        public OMReturnWeddingDress(Boolean ddc)
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedCells.Count > 0)
            {
                ...
                Form nc = new OMReturnWeddingAndReuturnReserved(customerName, customerID, "客户已取纱", "客户已还纱");
                nc.ShowDialog();
            }
